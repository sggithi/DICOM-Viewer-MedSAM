...
parser.add_argument(
    "-pretrained_checkpoint", type=str, default="work_dir/LiteMedSAM/medsam_lite_best_10.pth",
...
parser.add_argument(
    "-work_dir", type=str, default="./workdir/basic",
...
gts_path = join(data_root, 'gts')
imgs_path = join(data_root, 'imgs')
...
if medsam_lite_checkpoint is not None:
    if isfile(medsam_lite_checkpoint):
        ...
        #print("epoch", medsam_lite_ckpt['epoch'])
...
for epoch in range(start_epoch + 1, num_epochs + 1):
    ...
    iou_loss_output += epoch_iou_reduced
    print(f"Epoch{epoch}, loss {epoch_loss_reduced}, iou_loss{epoch_iou_reduced} ")


    epoch_loss_reduced = 1e10
    print("iou loss",iou_loss_output / epoch)
